                                        ...
                                        <div class="panel"  style="box-shadow: 0 1rem 2rem #d3cccc;   border-radius: 25px;margin-top:20px; ">
                                            ...
                                            <div class="panel-body p-20">
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
                                                        <?php $sql = "SELECT  distinct tblstudents.StudentName,tblstudents.RollId,tblstudents.StudentId,tblstudents.Status,tblresult.marks,tblresult.SubjectId,tblclasses.ClassName from tblresult join tblstudents on tblstudents.StudentId=tblresult.StudentId  join tblclasses on tblclasses.id=tblresult.ClassId";
                                                        ...
                                                        if ($query->rowCount() > 0) {
                                                            foreach ($results as $result) {   ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo htmlentities($result->marks); ?></td>                                                       <td><?php echo htmlentities($result->SubjectId); ?></td>
